...
var app = (function () {
            ...
            (function (t) {
              ...
              if (
                (h &&
                  ...
                  (h = null),
                  tt(n, l.b, "start"),
                  $ && (v(), (m = I(n, c, l.b, l.duration, 0, a, u.css)))),
                l)
              )
                if (t >= l.end)
                  b((c = l.b), 1 - c),
                    tt(n, l.b, "end"),
                    h || (l.b ? v() : --l.group.r || o(l.group.c)),
                    (l = null);
                else if (t >= l.start) {
                  const e = t - l.start;
  ...
  function vt(e) {
    ...
    return {
      ...
      m(t, e) {
        y(t, n, e), h(n, r), h(r, o), h(r, i), u.m(r, null);
      },
      p(t, [e]) {
        4 & e && j(o, "style", t[2]),
          a === (a = s(t)) && u
  ...
  class bt extends pt {
    constructor(t) {
      super(), gt(this, t, yt, vt, s, { value: 0, label: 1 });
    }
  }
  const $t = [];
  function wt(e, n = t) {
  ...
  let At;
  Rt.subscribe((t) => localStorage.setItem(xt, JSON.stringify(t)));
  const It = async (t) => {
      if (!At || !At[t]) {
        wkof.include("ItemData"), await wkof.ready("ItemData");
        let t = await wkof.ItemData.get_items();
        At = await wkof.ItemData.get_index(t, "subject_id");
      }
      return At[t];
    },
    qt = async () => {
    ...
    return {
      ...
      p(t, e) {
        32 & e && dt !== (dt = (100 * t[5]).toFixed() + "") && O(o, dt),
          ...
          16 & e && ht !== (ht = t[4].newKWeight + "") && O(G, ht),
          16 & e && mt !== (mt = t[4].newVWeight + "") && O(J, mt),
  ...
  function Mt(t) {
    ...
    return (
      (r = new bt({ props: { value: t[5] } })),
      {
        ...
        m(t, a) {
          y(t, e, a), y(t, n, a), lt(r, t, a), y(t, o, a), y(t, i, a), (s = !0);
        },
        p(t, e) {
          const n = {};
        ...
        i(t) {
          s || (it(r.$$.fragment, t), (s = !0));
        },
        o(t) {
          st(r.$$.fragment, t), (s = !1);
        },
        d(t) {
          t && b(e), t && b(n), ft(r, t), t && b(o), t && b(i);
        },
      }
    );
  }
  ...
  function Gt(t) {
    ...
    return {
      ...
      p(t, e) {
        2 & e && I !== (I = t[7](t[13].start) + "") && O(i, I),
          2 & e && q !== (q = t[8](t[13].end) + "") && O(a, q),
          2 & e && P !== (P = (t[6](t[13]) / 60).toFixed() + "") && O(c, P),
          2 & e && M !== (M = t[13].reviewCount + "") && O(g, M),
          2 & e && z !== (z = t[13].questionCount + "") && O(m, z),
          2 & e &&
    ...
    return (
      (t.$$.update = () => {
        2 & t.$$.dirty && n(4, (r = l.reduce((t, e) => t + +e.reviewCount, 0))),
          ...
          1025 & t.$$.dirty && n(11, (i = o > 0 ? g / o : 0)),
          2048 & t.$$.dirty && n(3, (s = `${i.toFixed(1)}`)),
          6144 & t.$$.dirty && n(2, (u = i / (2 * c.targetSpeed)));
      }),
      [
        o,
        l,
  ...
  function ee(e) {
    ...
    return {
      ...
      m(t, e) {
        y(t, n, e), h(n, r), h(n, o), h(n, i);
        for (let t = 0; t < l.length; t += 1) l[t].m(i, null);
        h(i, s), h(i, a);
      },
      p(t, [e]) {
        if (39 & e) {
          ...
          for (c = t[0], n = 0; n < c.length; n += 1) {
            const r = Yt(t, c, n);
            l[n] ? l[n].p(r, e) : ((l[n] = te(r)), l[n].c(), l[n].m(i, s));
          }
    ...
    return (
      ...
      (t.$$.update = () => {
        1 & t.$$.dirty && n(3, (r = Math.max(...s))),
          ...
          72 & t.$$.dirty && n(4, (i = Math.round((c / r) * 100)));
      }),
      [s, a, u, r, i, o, c]
    );
  }
  ...
  function oe(e) {
    ...
    function H(t, e) {
      return t[2].length > 2 ? ae : 2 === t[2].length ? se : void 0;
    }
    let X = H(e),
      J = X && X(e);
    return {
    ...
    return (
      (t.$$.update = () => {
        4 & t.$$.dirty && n(7, (r = l.map((t) => p(t.start)))),
          ...
          1026 & t.$$.dirty && n(6, (i = (o / f).toFixed())),
          4 & t.$$.dirty && n(5, (s = l.map((t) => t.review_count))),
          4 & t.$$.dirty && n(0, (u = l.map((t) => t.accuracy))),
          1 & t.$$.dirty &&
            n(4, (c = (100 * u.reduce((t, e) => t + e, 0)) / u.length));
      }),
      [u, o, l, d, c, s, i, r, g, p, f]
    );
  }
  class de extends pt {
    constructor(t) {
      super(), gt(this, t, fe, ue, s, {});
    }
  }
  function ge(t) {
    let e, n, r, i, s, a, c, l, f, d, g;
    const p = t[5].default,
      m = (function (t, e, n, r) {
        if (t) {
          const o = u(t, e, n, r);
    ...
    return {
      ...
      d(n) {
        n && b(e), m && m.d(n), t[7](null), (d = !1), o(g);
      },
    };
  }
  let pe;
  ...
  function ve(t, e, n) {
    ...
    (he[c] = {
      ...
      M(() => {
        delete he[c], window.removeEventListener("keydown", l);
      });
    return (
      (t.$$set = (t) => {
  ...
  class Ce extends pt {
    constructor(t) {
      super(), gt(this, t, we, $e, s, { errors: 1, path: 2 });
    }
  }
  function xe() {
    return (xe =
  ...
  var On = Ee(
    ...
    },
    {
      ...
      optional: function (t, e) {
        return qe(t) || null === t ? Oe(!0) : We(e, t);
      },
    },
    {
      shape: function (t, e) {
  ...
  function Dn(t) {
    ...
    return (function t(r) {
      return function () {
        ...
        var s = On[r];
        n.push(function (t) {
          return Fn.apply(void 0, Ne([s.apply(void 0, Ne([t], o)), r, t], o));
        });
        var a = {
          run: function (t) {
            return ke(
              Se(n, function (n, r) {
                ...
                i.pass ||
                  r(
                    Oe(
                      !!i.pass,
                      null !== (o = je(e, t, i.message)) && void 0 !== o
                        ? o
                        : i.message
                    )
                  );
      ...
      ((Rn = xe(
        ...
        },
        {
          partial: function (t) {
            var e,
              n = {};
            for (e in t) n[e] = An.optional(t[e]);
            return n;
          },
        }
      )),
              ...
              function e(e, n, r) {
                return function () {
                  ...
                  if (
                    ...
                    if (!cn(i.message)) throw i.message;
  ...
  function qn(t) {
    ...
    function n(e, n) {
      ...
      (r.references[e] = n), _e((e = o[e][1])) && e(n, i), _e(t) && t();
    }
    var r = { references: [] },
      o = [];
    return {
  ...
  function Vn(t, e) {
    for (var n = [], r = 0; r < t.length; r++) {
      var o = t[r];
      Xe(o) ? n.push(Vn(o, e)) : ((o = e(o)), Ie(o) && n.push(o));
    }
    return n;
  }
  function Bn(t) {
  ...
  function cr(t, e) {
    return (t = sr(t, tr(), { fieldName: e })), e ? t[e] : t;
  }
  function lr(t, e) {
          ...
          (function () {
            ...
            return (
              tr().forEach(function (e) {
                var n = e.fieldName,
                  r = e.groupName;
                (t.tests[n] = ir(t.tests, e)),
                  r &&
                    ((t.groups[r] = t.groups[r] || {}),
                    (t.groups[r][n] = ir(t.groups[r], e)));
              }),
              (function (t) {
  ...
  var Ar,
    Ir = Ar || (Ar = {});
  (Ir.Error = "error"), (Ir.Warning = "warning");
  var qr = (function () {
      function t(t, e, n) {
        var r = void 0 === n ? {} : n;
        (n = r.message),
      ...
      return (
        (t.prototype.run = function () {
          try {
            ...
            (t = e), qe(this.message) && Me(t) && (this.message = e), (t = !1);
          }
        ...
        (t.prototype.warns = function () {
          return this.severity === Ar.Warning;
        }),
  ...
  function Gr(t) {
    ...
    if (e && _e(e.then)) {
      var r = Or().emit,
        o = Xn(),
        i = Un.bind({ stateRef: o }, function () {
          Jn(), r(Wr.TEST_COMPLETED, t);
        });
      o = Un.bind({ stateRef: o }, function (e) {
        t.isCanceled() || ((t.message = Me(e) ? e : n), t.fail(), i());
      });
      try {
        e.then(i, o);
      } catch (t) {
  ...
  function Xr(t) {
    ...
    if (
      (function (t) {
        ...
        if (((o = !0 === o), t)) {
          t: {
            var i = Un.useX().exclusion.groups;
          ...
          if (s) return !0;
          if (!0 === n.groups[t]) return !(o || (!Rr(r) && !1 !== r[e]));
        }
        return !o && Rr(r);
      })(t)
    )
      ...
      var n = (function (t) {
        return Un.run({ currentTest: t }, function () {
          try {
            ...
            (e = n), qe(t.message) && Me(e) && (t.message = n), (e = !1);
          }
          return !1 === e && t.fail(), e;
        });
      })(t);
  ...
  function Jr(t) {
    ...
    var r = Un.useX();
    return Xr((e = new qr(t, e, { message: n, groupName: r.groupName })));
  }
  var Yr = Ee(Jr, {
    each: (function (t) {
      return function (e) {
  ...
  const Zr = (function () {
    ...
    var r = kr(),
      o = qn();
    return (
      (t = { stateRef: zn(o, { suiteId: In(), suiteName: t }), bus: r }),
      Ee(
        Un.bind(t, function () {
    ...
    Fr(e),
      Yr("newRWeight", "Must be between 0 and 3", () => {
        An(t.newRWeight).gte(0), An(t.newRWeight).lte(3);
      }),
      Yr("newKWeight", "Must be between 0 and 3", () => {
        An(t.newKWeight).gte(0), An(t.newKWeight).lte(3);
      }),
      Yr("newVWeight", "Must be between 0 and 3", () => {
        An(t.newVWeight).gte(0), An(t.newVWeight).lte(3);
      });
  });
  function Qr(t) {
    let e,
    ...
    return (
      ...
      (A = new Ce({ props: { errors: t[1], path: "newKWeight" } })),
      ...
      (ve = new Ce({ props: { errors: t[1], path: "tzOffset" } })),
      {
        c() {
          (e = w("form")),
            ...
            (I = N()),
            (q = w("label")),
            (q.textContent = "Weighting factor for new vocabulary"),
            (P = N()),
            (M = w("input")),
            (z = N()),
            ct(L.$$.fragment),
            ...
            j(At, "for", "goodColor"),
            j(At, "class", "svelte-1ljtm41"),
            j(qt, "type", "color"),
            j(qt, "name", "goodColor"),
            j(qt, "id", "goodColor"),
            j(qt, "class", "svelte-1ljtm41"),
            j(Mt, "for", "warnColor"),
        ...
        p(t, [e]) {
          1 & e && W(u, t[0].targetApprentice),
            (!xe || 1 & e) &&
              ...
              O(f, _e),
            1 & e && k(m.value) !== t[0].newRWeight && W(m, t[0].newRWeight);
          const n = {};
          2 & e && (n.errors = t[1]),
            $.$set(n),
          ...
          2 & e && (o.errors = t[1]),
            ...
            (!xe || 1 & e) && T(ht, "color", t[0].textColor),
            ...
            1 & e && W(qt, t[0].goodColor),
            1 & e && W(Lt, t[0].warnColor),
            1 & e && W(Bt, t[0].alertColor),
            1 & e && W(re, t[0].madCutoff),
            (!xe || 1 & e) && ke !== (ke = t[0].madCutoff + "") && O(se, ke);
          const i = {};
          2 & e && (i.errors = t[1]),
            ue.$set(i),
            1 & e && W(de, t[0].tzOffset),
            (!xe || 1 & e) && Oe !== (Oe = t[0].tzOffset + "") && O(he, Oe);
          const s = {};
          2 & e && (s.errors = t[1]), ve.$set(s);
        },
        i(t) {
          xe ||
            (it($.$$.fragment, t),
        ...
        d(t) {
          t && b(e), ft($), ft(A), ft(L), ft(ue), ft(ve), (Ne = !1), o(Ee);
        },
      }
    );
  }
    ...
    return [
      ...
      () => {
        ...
        t.hasErrors()
          ? n(1, (i = t.getErrors()))
          : (n(1, (i = {})),
            c(Rt, (r = Object.assign(Object.assign({}, r), o)), r));
      },
      () => {
        n(0, (o = Object.assign({}, Dt))), n(1, (i = {}));
      },
      () => {
  ...
  const io = (t) => {
    ...
    uo = async (t) => {
      ...
      const e = t.map(so).map(ao),
        n = await (async (t) => {
          let e = t.slice();
          for (let t of e) {
            const e = await It(+t.subject_id);
      ...
      const e = ((t) => {
          ...
          if ((Math.max(...e), n > 6e5)) return e.map((t, e) => e);
          {
            const n = io(e),
              ...
              a = 10,
              u = s[s.length - 1] > a ? s : [...s.slice(0, -1), 999999],
              c = t.map((t, e) => e),
  ...
  function vo(e) {
    let n,
      r = po(3, 1),
      o = [];
    for (let t = 0; t < r.length; t += 1) o[t] = mo(ho(e, r, t));
    return {
      c() {
        n = w("div");
      ...
      p(t, [e]) {
        if (59 & e) {
          let i;
          for (r = po(3, 1), i = 0; i < r.length; i += 1) {
            const s = ho(t, r, i);
            o[i] ? o[i].p(s, e) : ((o[i] = mo(s)), o[i].c(), o[i].m(n, null));
          }
  ...
  class bo extends pt {
    constructor(t) {
      super(),
        gt(this, t, yo, vo, s, { color: 0, unit: 1, duration: 2, size: 3 });
    }
  }
  function $o(t) {
    let e, n, r, o;
    return (
      (n = new bo({ props: { size: "25", unit: "px" } })),
      {
        c() {
          (e = w("div")),
            ct(n.$$.fragment),
            j(e, "class", "spinner svelte-ohi7in");
        },
        m(t, r) {
      ...
      })),
      {
        c() {
          (e = w("div")),
            ...
            ct(D.$$.fragment),
            j(r, "for", "review-days"),
            j(r, "class", "svelte-ohi7in"),
            j(s, "type", "number"),
            j(s, "id", "review-days"),
            j(s, "name", "review-days"),
            j(s, "min", "1"),
            j(s, "max", "7"),
            j(s, "class", "svelte-ohi7in"),
            j(n, "class", "retrieval svelte-ohi7in"),
            j(l, "class", "svelte-ohi7in"),
            F(l, "active", "chart" === t[2]),
            j(d, "class", "svelte-ohi7in"),
            F(d, "active", "data" === t[2]),
            j(c, "class", "navigation svelte-ohi7in"),
            j(e, "class", "controls svelte-ohi7in"),
        ...
        p(t, [n]) {
          1 & n && k(s.value) !== t[0] && W(s, t[0]),
            t[1]
              ? q
                ? 2 & n && it(q, 1)
                : ((q = $o()), q.c(), it(q, 1), q.m(e, u))
              : q &&
                (rt(),
                st(q, 1, 1, () => {
                  q = null;
